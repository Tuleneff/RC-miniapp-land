...
export default function SolutionHR() {
  const segment = segments.hr
  ...
  return (
    <div className="bg-bg-50">
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-text-900">
              Метрики, которые <span className="text-primary-600">можно показать CEO</span>
            </h2>
          </motion.div>
      ...
      {/* CTA */}
      <CTASection
        title="Готовы улучшить адаптацию и удержание?"
        description="Запустите Mini App для команды и увидьте первые результаты через 2 недели"

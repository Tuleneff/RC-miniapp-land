...
export default function SolutionCM() {
  const segment = segments.cm
  ...
  return (
    <div className="bg-bg-50">
        ...
        <div className="container-wide">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-text-900">
              С чем сталкиваются комьюнити-менеджеры
            </h2>
          </motion.div>
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-text-900">
              Метрики, которые <span className="text-primary-600">сберегут ваши нервы</span>
            </h2>
          </motion.div>
      ...
      <CTASection
        ...
        description="Подключите бота и сфокусируйтесь на стратегических задачах"

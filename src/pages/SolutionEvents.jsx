...
export default function SolutionEvents() {
  ...
  return (
    <div className="bg-bg-50">
        ...
        <div className="container-wide">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-text-900">
              С чем сталкиваются организаторы
            </h2>
          </motion.div>
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-text-900">
              Метрики, которые <span className="text-primary-600">важны спонсорам</span>
            </h2>
          </motion.div>
      ...
      <CTASection
        title="Готовы сделать ивент незабываемым?"
        description="Подключите бота и дайте участникам удобный инструмент для нетворкинга"
